...
Demo 1 **0.8.4** · Pokémon Essentials **21.1**
...
Mac: unzip Tidebound_Mac_0.8.4.zip, move Tidebound.app to Applications and
...
The editable project and game bible are in Tidebound_Project_0.8.4.zip.
