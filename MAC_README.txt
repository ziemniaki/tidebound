...
Controls: arrows to move; Return to interact/confirm; Esc or X for the menu/back.
Fn-F1 opens key bindings on keyboards that use F1 for screen brightness.
Save through the in-game menu.

Opening: play with Natu in your bedroom, then go downstairs for Mother's talk.
Take Pookie (asleep beside the lighthouse) for 100 steps around the village.
If she runs to the pier, speak to her there to get her following again; visiting
the pier is optional. Return home together and choose a companion. Mother then
asks for oil. Find the locked-out seller's keys among the northern forest's
white flowers, bring them back, enter his shop for oil, and tend the lamp at home.
The notebook records your next step. Text clipping is fixed in this version.
...
keep a backup of an old save before saving a new game over it.

Save identity stays Tidebound_Opening_0_2. The runtime stores saves outside the
app, normally under ~/Library/Application Support/Tidebound_Opening_0_2/.
...
This is an unofficial Pokemon fan project with temporary stock art.

0.5.1 restores permanent night. Continue your existing save to see the darker
coast; the computer clock will not bring daylight. The new shoreline remains.

0.6: Continue your existing save and speak to the oil seller inside his shop.
He offers a pie; share it with Mother, then bring back his plate to begin the
new coastal pursuit. No restart or new runtime is required.
...
0.7.14: richer forests, rocky shore and lighthouse garden, coastal groves and
water depth. Continue your current save. New Game still starts with 99 Rare
Candies for evolution testing. No changes to Pokemon, quests or recovery rules.

0.7.15: denser forests and rock boundaries, whole small-rock sprites, aligned doorway cues. Continue existing saves.
